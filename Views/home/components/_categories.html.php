            ...
            <div class="categories__present-box">
                ...
                <div class="categories__present-right">
                    <div class="present__right_1 right__box">
                        <a href="https://genshin.hoyoverse.com/fr/news" target="_blank">
                            <h3>Nouveautés</h3>
                        </a>
                    </div>
                    <div class="present__right_2 right__box">
                        <a href="https://www.jeuxvideo.com/news/1622214/genshin-impact-les-bannieres-de-la-version-3-0-sont-elles-rentables-dendro-edition.htm" target="_blank">
                            <h3>Bannières</h3>
                        </a>
                    </div>
                    <div class="present__right_3 right__box">
                        <a href="https://www.genshin-impact.fr/guides-events/" target="_blank">
                            <h3>Evénement</h3>
                        </a>
                    </div>
                    <div class="present__right_4 right__box">
                        <a href="https://genshin.hoyoverse.com/fr/download" target="_blank">
                            <h3>Télécharger</h3>
                        </a>
                    </div>
                </div>
